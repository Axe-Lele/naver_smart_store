<!-- /.claude/skills/desktop-release-verification/SKILL.md -->
---
...
4. If installer scripts or build config changed, verify NSIS output path and smoke-install expectations.
