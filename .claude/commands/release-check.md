...
3. Verify `npm run desktop:build`
4. If installer/runtime packaging changed, verify `npm run desktop:dist`
5. State clearly whether the change was checked in dev mode only or also in packaged/installer mode
